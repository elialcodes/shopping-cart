...
//2. CREAMOS EL PROVIDER (el proveedor del context) para que lo usen los componentes
// que lo necesiten, creamos una función con el parámetro children como props
